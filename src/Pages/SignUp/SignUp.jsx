...
import { faFaceSmileBeam, faLock,faEye } from "@fortawesome/free-solid-svg-icons";
      ...
      <div className="flex items-center justify-center">
        <div className="signup-form ">
          ...
          <form>
            ...
            <button className="w-full py-5 text-base rounded-3xl font-medium bg-blue-500 text-white" type="submit">Sign Up</button>
            <div className="my-7">
              <p className="text-center text-gray-400 font-medium ">
                Already have an account? <Link className="text-blue-500" to="/sign-in">Sign In</Link>
              </p>
            </div>
          </form>
        </div>
