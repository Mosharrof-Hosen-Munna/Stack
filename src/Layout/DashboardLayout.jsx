  ...
  return (
    <div className="flex justify-start">
      ...
      <div className="w-full px-10">
        <div className="flex sticky top-0 bg-white z-50 justify-between">
          <div className="my-6 relative">
            <input
              style={{ width: "540px" }}
              type="text"
              class=" border border-gray-100 bg-secondary font-medium text-gray-900 text-sm rounded-xl focus:outline-gray-200 block w-full pl-5 py-4  "
              placeholder="Search"
              name="search"
            />
            <button
          ...
          <div className="flex items-center">
            ...
            <img
              className="w-10 h-10 ml-11  rounded-full"
